...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/bosqu93/v5/main/ipvps | grep $MYIP )
if [ $MYIP = $MYIP ]; then
...
# ==================================================
# Link Hosting Kalian
bosqu="raw.githubusercontent.com/bosqu93/v5/main/wireguard"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/Tarap-Kuhing/sc/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/Tarap-Kuhing/sc/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/Tarap-Kuhing/sc/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
