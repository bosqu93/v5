...
# ==================================================
# Link Hosting Kalian
bagusid93="raw.githubusercontent.com/bosqu93/v5/main/wireguard"
...
wget -O /usr/bin/addl2tp https://${bagusid93}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${bagusid93}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${bagusid93}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://${bagusid93}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://${bagusid93}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://${bagusid93}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
