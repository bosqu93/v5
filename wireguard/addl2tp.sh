...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/bosqu93/v5/main/ivps > /root/tmp
...
until [[ $VPN_USER =~ ^[a-zA-Z0-9_]+$ && ${CLIENT_EXISTS} == '0' ]]; do
		...
		CLIENT_EXISTS=$(grep -w $VPN_USER /var/lib/ipvps.conf | wc -l)
...
echo -e "### $VPN_USER $exp">>"/var/lib/ipvps.conf"
cat <<EOF
