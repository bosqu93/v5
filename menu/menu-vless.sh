...
clear
echo -e "\033[1;91m┌─────────────────────────────────────────────────┐${NC}"
echo -e "${BBall}              ${BIPurple}• VLESS PANEL MENU •                ${TC}"
echo -e "\033[1;91m└─────────────────────────────────────────────────┘${NC}"
echo -e "\033[1;91m┌─────────────────────────────────────────────────┐${NC}"
echo -e " $COLOR1$NC${WH}[${BICyan}01${NC}]${NC} ${COLOR1}• ${BIYellow}ADD VLESS${NC}       ${WH}[${BICyan}05${NC}]${NC} ${COLOR1}• ${BIYellow}USER ONLINE${NC}   $COLOR1 $NC"
echo -e " $COLOR1 $NC                                              ${NC} $COLOR1 $NC"
echo -e " $COLOR1$NC${WH}[${BICyan}02${NC}]${NC} ${COLOR1}• ${BIYellow}TRIAL VLESS${NC}     ${WH}[${BICyan}06${NC}]${NC} ${COLOR1}• ${BIYellow}CEK CONFIG${NC}    $COLOR1 $NC"
echo -e " $COLOR1 $NC                                              ${NC} $COLOR1 $NC"
echo -e " $COLOR1$NC${WH}[${BICyan}03${NC}]${NC} ${COLOR1}• ${BIYellow}RENEW VLESS${NC}     ${WH}[${BICyan}07${NC}]${NC} ${COLOR1}• ${BIYellow}VLESS MANUAL UUID${NC}    $COLOR1 $NC"
echo -e " $COLOR1 $NC                                              ${NC} $COLOR1 $NC"
...
echo -e "${BBall}               ${BIPurple}• PAPADA'AN STORE •                ${TC}"
echo -e "\033[1;91m└─────────────────────────────────────────────────┘${NC}"
echo -e ""
