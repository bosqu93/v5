...
Isadmin=$(curl -sS https://raw.githubusercontent.com/bosqu93/v5/main/ipvps | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/bosqu93/v5/main/ipvps | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
Exp1=$(curl https://raw.githubusercontent.com/bosqu93/v5/main/ipvps | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
    sts="${Info}"
else
    sts="${Error}"
...
clear
status=$( curl -sS https://raw.githubusercontent.com/bosqu93/v5/main/status )
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
serverV=$( curl -sS https://raw.githubusercontent.com/bosqu93/v5/main/versi )
if [ "$Isadmin" = "ON" ]; then
uis="${COLOR1}Premium User$NC"
else
uis="${COLOR1}Premium Version$NC"
fi
echo -e "$COLOR1 $NC ${HH}User Roles        ${COLOR1}: ${WH}$uis"
if [ "$cekup" = "day" ]; then
echo -e "$COLOR1 $NC ${HH}System Uptime     ${COLOR1}: ${WH}$uphours $upminutes $uptimecek"
else
echo -e "$COLOR1 $NC ${HH}System Uptime     ${COLOR1}: ${WH}$uphours $upminutes"
fi
echo -e "$COLOR1 $NC ${HH}Memory Usage      ${COLOR1}: ${WH}$uram / $tram"
echo -e "$COLOR1 $NC ${HH}Date              ${COLOR1}: ${WH}$DATEVPS $TIMEZONE${NC}"
echo -e "$COLOR1 $NC ${HH}ISP               ${COLOR1}: ${WH}$ISP"
echo -e "$COLOR1 $NC ${HH}City              ${COLOR1}: ${WH}$CITY"
echo -e "$COLOR1 $NC ${HH}Current Domain    ${COLOR1}: ${WH}$(cat /etc/xray/domain)"
echo -e "$COLOR1 $NC ${HH}NS Domain         ${COLOR1}: ${WH}$(cat /etc/xray/dns)"
echo -e "$COLOR1 $NC ${HH}IP-VPS            ${COLOR1}: ${WH}$IPVPS${NC}"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 $NC ${WH}[ SSH WS : \033[1;93m${status_ws}${NC} ${WH}]  ${WH}[ XRAY : \033[1;93m${status_xray}${NC} ${WH}]   ${WH}[ NGINX : \033[1;93m${status_nginx}${NC} ${WH}] $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "        $COLOR1   \033[1;96mSSH   VMESS   VLESS   TROJAN ${NC}"
echo -e "        $COLOR1    \033[1;93m$ssh1      \033[1;93m$vmc       \033[1;93m$vlx       \033[1;93m$trx ${NC}"

echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "  ${WH}[${COLOR1}01${WH}]${NC} ${COLOR1}• ${HH}MENU${COLOR1}•${WH}SSHWS     "        "${WH}[${COLOR1}06${WH}]${NC} ${COLOR1}• ${HH}MENU${COLOR1}•${WH}SYSTEM    $COLOR1 ${NC}"
echo -e " $COLOR1 $NC                                              ${NC} $COLOR1 $NC"
echo -e "  ${WH}[${COLOR1}02${WH}]${NC} ${COLOR1}• ${HH}MENU${COLOR1}•${WH}VMESS     "        "${WH}[${COLOR1}07${WH}]${NC} ${COLOR1}• ${HH}MENU${COLOR1}•${WH}RUNNING    $COLOR1 ${NC}"
echo -e " $COLOR1 $NC                                              ${NC} $COLOR1 $NC"
echo -e "  ${WH}[${COLOR1}03${WH}]${NC} ${COLOR1}• ${HH}MENU${COLOR1}•${WH}VLESS     "        "${WH}[${COLOR1}08${WH}]${NC} ${COLOR1}• ${HH}MENU${COLOR1}•${WH}THEME    $COLOR1 ${NC}"
echo -e " $COLOR1 $NC                                              ${NC} $COLOR1 $NC"
echo -e "  ${WH}[${COLOR1}04${WH}]${NC} ${COLOR1}• ${HH}MENU${COLOR1}•${WH}TROJAN    "        "${WH}[${COLOR1}09${WH}]${NC} ${COLOR1}• ${HH}MENU${COLOR1}•${WH}UPDATE    $COLOR1 ${NC}"
echo -e " $COLOR1 $NC                                              ${NC} $COLOR1 $NC"
echo -e "  ${WH}[${COLOR1}05${WH}]${NC} ${COLOR1}• ${HH}MENU${COLOR1}•${WH}L2TP/PPTP "        "${WH}[${COLOR1}10${WH}]${NC} ${COLOR1}• ${HH}MENU${COLOR1}•${WH}BACKUP    $COLOR1 ${NC}"
echo -e " $COLOR1 $NC                                              ${NC} $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
echo -e "$COLOR1┌─────────────────────────────────────────────────┐$NC"
echo -e "$COLOR1 $NC ${WH}Version     ${COLOR1}: ${WH}$serverV \033[1;96mLatest Version${NC}"
echo -e "$COLOR1 $NC ${WH}Client Name ${COLOR1}: \033[1;95m$Name${NC}"
echo -e "$COLOR1 $NC ${WH}Exp Script  ${COLOR1}: \033[1;91m$exp ${NC}"
echo -e "$COLOR1└─────────────────────────────────────────────────┘$NC"
echo -e "$COLOR1┌────────────────────── ${WH}BY${NC} ${COLOR1}───────────────────────┐${NC}"
echo -e "$COLOR1 ${NC}                \033[1;93m• •${NC}                 $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo ""
echo -e   " [\e[33m Tekan x Untuk Exit Script \033[0m]"
echo ""
...
05 | 5) clear ; menu-l2tp ;;
06 | 6) clear ; menu-set ;;
07 | 7) clear ; running ;;
08 | 8) clear ; m-theme ;;
19 | 9) clear ; menu-update ;;
10 | 10) clear ; menu-bckp ;;
11 | 11) clear ; $ressee ;;
12 | 12) clear ; $bottt ;;
