...
clear
echo -e "\033[1;91m┌─────────────────────────────────────────────────┐${NC}"
echo -e "${BBall}              ${BIPurple}• VMESS PANEL MENU •                ${TC}"
echo -e "\033[1;91m└─────────────────────────────────────────────────┘${NC}"
echo -e "\033[1;91m┌─────────────────────────────────────────────────┐${NC}"
echo -e " $COLOR1 $NC${WH}[${BICyan}01${NC}]${NC} ${COLOR1}• ${BIYellow}ADD VMESS${NC}       ${WH}[${BICyan}05${NC}]${NC} ${COLOR1}• ${BIYellow}USER ONLINE${NC}   $COLOR1 $NC"
echo -e " $COLOR1 $NC                                              ${NC} $COLOR1 $NC"
echo -e " $COLOR1 $NC${WH}[${BICyan}02${NC}]${NC} ${COLOR1}• ${BIYellow}TRIAL VMESS${NC}     ${WH}[${BICyan}06${NC}]${NC} ${COLOR1}• ${BIYellow}CEK CONFIG${NC}    $COLOR1 $NC"
echo -e " $COLOR1 $NC                                              ${NC} $COLOR1 $NC"
echo -e " $COLOR1 $NC${WH}[${BICyan}03${NC}]${NC} ${COLOR1}• ${BIYellow}RENEW VMESS${NC}     ${WH}[${BICyan}07${NC}]${NC} ${COLOR1}• ${BIYellow}VMESS MANUAL UUID${NC}    $COLOR1 $NC"
echo -e " $COLOR1 $NC                                              ${NC} $COLOR1 $NC"
